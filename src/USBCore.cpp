...
/**
	changes made by okiraku-camera....
		USB_CONFIG_POWER to 100.
		undef TXLED0, TXLED1, RXLED0, RXLED1, TX_RX_LED_INIT
		TX_RX_LED_PULSE_MS to 0
*/
...
// begin okiraku-camera 
#ifdef USB_CONFIG_POWER
#undef USB_CONFIG_POWER
